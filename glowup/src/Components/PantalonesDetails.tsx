...
interface PantalonesDetailsProps {
  addToCart: (product: Pantalones) => void;
}

const PantalonesDetails: FunctionComponent<PantalonesDetailsProps> = ({ addToCart }) => {
  ...
  const [cartItems, setCartItems] = useState<{ [key: number]: Pantalones }>({});
  ...
  const handleAddToCart = async (product: Pantalones) => {
...
export default PantalonesDetails;
