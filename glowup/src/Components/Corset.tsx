...
interface CorsetProps {
  addToCart: (product: Corset) => void;
}

const CorsetPage: FunctionComponent<CorsetProps> = ({ addToCart }) => {
  // const { Accesorios } = products;

  const [isCartModalOpen, setIsCartModalOpen] = useState<boolean>(false);
  const [selectedProduct, setSelectedProduct] = useState<Corset | null>(
    null
  );
  ...
  const handleOpenCartModal = (product: Corset) => {
