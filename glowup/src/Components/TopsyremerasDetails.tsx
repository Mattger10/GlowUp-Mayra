...
interface TopsyRemerasDetailsProps {
  addToCart: (product: TopsyRemeras) => void;
}

const TopsyRemerasDetails: FunctionComponent<TopsyRemerasDetailsProps> = ({ addToCart }) => {
  ...
  const [cartItems, setCartItems] = useState<{ [key: number]: TopsyRemeras }>({});
  ...
  const handleAddToCart = async (product: TopsyRemeras) => {
...
export default TopsyRemerasDetails;
