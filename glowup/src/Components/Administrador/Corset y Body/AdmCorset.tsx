...
import useFirestoreProductos, {
  Corset,
} from "../../Firestore/FirestoreHandlerCorset";
  ...
  return (
    ...
    >
      ...
      <Box sx={{ width: "100%", marginTop: "-2rem" }}>
        ...
        >
          <Link to="/administrador/agregarcorsetybody">
            <Button
              sx={{
                color: "white",
              ...
              {lista.map((producto: Corset) => (
                <TableRow key={producto.id}>
                  ...
                  >
                    <>
                      <Link
                        to={`/administrador/editcorsetybody/${producto.id}`}
