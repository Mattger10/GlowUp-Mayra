...
const AgregarVestidosyEnterizos = () => {
  ...
  const guardarInfo = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const productosRef = collection(db, "Vestidos y enterizos");
...
export default AgregarVestidosyEnterizos;
