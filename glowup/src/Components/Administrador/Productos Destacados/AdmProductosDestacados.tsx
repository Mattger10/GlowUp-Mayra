...
import useFirestoreProductos, {
  Producto,
} from "../../Firestore/FirestoreHandler";
...
const AdmProductosDestacados = () => {
  const { lista, setLista } = useFirestoreProductos();
  ...
  return (
    ...
    >
      ...
      <Box sx={{ width: "100%", marginTop: "-2rem" }}>
        ...
        >
          <Link to="/administrador/agregarproductosdestacados">
            <Button
              sx={{
                color: "white",
              ...
              {lista.map((producto: Producto) => (
                <TableRow key={producto.id}>
                  ...
                  >
                    <>
                      <Link
                        to={`/administrador/editdestacados/${producto.id}`} 
...
export default AdmProductosDestacados;
