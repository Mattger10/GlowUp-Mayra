...
import useFirestoreProductos from "../../Firestore/FirestoreHandler";
...
interface EditProductosDestacadosProps {}

const EditProductosDestacados: FunctionComponent<EditProductosDestacadosProps> = () => {
  const { id } = useParams<{ id: string }>();
  const { lista, actualizarProducto } = useFirestoreProductos();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(false);
    navigate("/administrador/destacados"); // Redirigir al usuario a la ruta deseada
  };
...
export default EditProductosDestacados;
