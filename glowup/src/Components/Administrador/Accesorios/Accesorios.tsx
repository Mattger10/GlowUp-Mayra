...
import useFirestoreProductos, {
  Accesorios,
} from "../../Firestore/FirestoreHandlerAccesorios";
  ...
  return (
    ...
    >
      ...
      <Box sx={{ width: "100%", marginTop: "-2rem" }}>
        ...
        >
          <Link to="/administrador/agregaraccesorios">
            <Button
              sx={{
                color: "white",
              ...
              {lista.map((producto: Accesorios) => (
                <TableRow key={producto.id}>
                  ...
                  >
                    <>
                      <Link
                        to={`/administrador/editaccesorios/${producto.id}`}
