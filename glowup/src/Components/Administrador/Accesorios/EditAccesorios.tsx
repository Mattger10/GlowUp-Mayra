...
import { Accesorios } from "../../Firestore/FirestoreHandlerAccesorios";
import {
  Button,
  TextField,
  Typography,
...
import useFirestoreProductos from "../../Firestore/FirestoreHandlerAccesorios";
...
interface EditAccesoriosProps {}

const EditAccesorios: FunctionComponent<EditAccesoriosProps> = () => {
  const { id } = useParams<{ id: string }>();
  const { lista, actualizarAccesorio } = useFirestoreProductos();
  const [formData, setFormData] = useState<Partial<Accesorios>>({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await actualizarAccesorio(id, formData);
