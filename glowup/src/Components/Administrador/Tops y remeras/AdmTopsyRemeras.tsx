import {
  ...
  import useFirestoreTopsyRemeras, {
    TopsyRemeras,
  } from "../../Firestore/FirestoreHandlerTopsyRemeras";
  ...
  const AdmTopsyRemeras = () => {
    const { lista, setLista } = useFirestoreTopsyRemeras();
    ...
    return (
      ...
      >
        ...
        <Box sx={{ width: "100%", marginTop: "-2rem" }}>
          ...
          >
            <Link to="/administrador/agregartopsyremeras">
              <Button
                sx={{
                  color: "white",
          ...
          <TableContainer component={Paper}>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              ...
              <TableBody>
                {lista.map((producto: TopsyRemeras) => (
                  <TableRow key={producto.id}>
                    ...
                    >
                      <>
                        <Link
                          to={`/administrador/edittopsyremeras/${producto.id}`}
  ...
  export default AdmTopsyRemeras;
