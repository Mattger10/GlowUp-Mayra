import {
  ...
  import useFirestorePantalones, {
    Pantalones,
  } from "../../Firestore/FirestoreHandlerPantalones";
  ...
  const AdmPantalones = () => {
    const { lista, setLista } = useFirestorePantalones();
    ...
    return (
      ...
      >
        ...
        <Box sx={{ width: "100%", marginTop: "-2rem" }}>
          ...
          >
            <Link to="/administrador/agregarpantalones">
              <Button
                sx={{
                  color: "white",
                ...
                {lista.map((producto: Pantalones) => (
                  <TableRow key={producto.id}>
                    ...
                    >
                      <>
                        <Link
                          to={`/administrador/editpantalones/${producto.id}`}
