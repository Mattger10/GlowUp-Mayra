...
interface AccesoriosDetailsProps {
  addToCart: (product: Accesorios) => void;
}

const AccesoriosDetails: FunctionComponent<AccesoriosDetailsProps> = ({ addToCart }) => {
  ...
  const [cartItems, setCartItems] = useState<{ [key: number]: Accesorios }>({});
  ...
  const handleAddToCart = async (product: Accesorios) => {
