...
interface BlusasProps {
  addToCart: (product: BlusasyCamisas) => void;
}

const BlusasPage: FunctionComponent<BlusasProps> = ({ addToCart }) => {
  // const { Accesorios } = products;

  const [isCartModalOpen, setIsCartModalOpen] = useState<boolean>(false);
  const [selectedProduct, setSelectedProduct] = useState<BlusasyCamisas | null>(
    null
  );
  ...
  const handleOpenCartModal = (product: BlusasyCamisas) => {
